		...
		<div id="spy-container" class="col-12 col-md-8 px-0 mb-4" tabindex="0">
			<form role="form" class="ai-tagger-settings">
				...
				<div class="mb-4">
					...
					<div class="mb-3" data-type="sorted-list" data-sorted-list="sample-list" data-item-template="admin/plugins/ai-tagger/partials/sorted-list/item" data-form-template="admin/plugins/ai-tagger/partials/sorted-list/form">
